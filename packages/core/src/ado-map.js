...
export const ADO_STATE_TO_PHASE = {
    new: "intake",
    proposed: "intake",
    "to do": "intake",
    approved: "shaping",
...
export const PHASE_TO_ADO_STATE = {
    intake: "New",
    shaping: "New",
    building: "Active",
    review: "Resolved",
...
export const TASK_STATE_TO_ADO_STATE = {
    pending: "New",
    in_progress: "Active",
...
export const mapAdoType = (raw) => ADO_TYPE_TO_DCC[raw.trim().toLowerCase()] ?? "task";
export const mapAdoState = (raw) => ADO_STATE_TO_PHASE[raw.trim().toLowerCase()] ?? "intake";
export const htmlToText = (s) => s
    .replace(/<br\s*\/?>/gi, "\n")
    ...
    .replace(/\n{3,}/g, "\n\n")
    .trim();
//# sourceMappingURL=ado-map.js.map