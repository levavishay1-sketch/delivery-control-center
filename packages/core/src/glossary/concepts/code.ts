...
export const CODE_CONCEPTS: Concept[] = [
  ...
  { key: "file_compare", kind: "section", title: "לפני ואחרי", aliases: ["השוואת קבצים", "diff"], explain: "התוכן של הקובץ לפני השינוי ואחריו, זה לצד זה. שורות שלא השתנו מקופלות כדי שיהיה קל לראות מה באמת נגעו בו." },
