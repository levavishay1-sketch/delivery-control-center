...
export const PAGE_CONCEPTS: Concept[] = [
  ...
  { key: "page_client", kind: "section", title: "מסך לקוח", aliases: ["לקוח"], explain: "הדרישות, המאגרים והחיבור ל-Azure DevOps של לקוח אחד. מכאן מייבאים דרישות ומקשרים מאגר." },
  ...
  { key: "page_flow", kind: "section", title: "מפת הדרישה", aliases: ["flow", "היררכיה"], explain: "הדרישה וכל המשימות שמתחתיה, לצד האפיון שממנו הן נגזרו. שני מתגים קובעים מה רואים: תוכן — היררכיה (מה שייך למה) או תלויות (מה לפני מה); ופריסה — רשימה מקוננת או קוביות. לחיצה על משימה צובעת את מה שהיא מממשת באפיון, ולהפך." },
