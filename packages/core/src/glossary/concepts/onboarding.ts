...
export const ONBOARDING_CONCEPTS: Concept[] = [
  ...
  { key: "onboarding_review", kind: "button", title: "סקירת הקבצים", aliases: ["review", "סקירה"], screens: ["onboarding"], explain: "רשימת כל הקבצים שהסשן שינה, עם לפני/אחרי. ליד כל קובץ כתוב למה הוא נוצר ומה התרומה שלו, בעקבות מה הוא עודכן, או למה הוא נמחק. אפשר לבקש מהסשן תיקונים בטרמינל, והרשימה מתעדכנת לבד; אפשר גם לרענן ידנית.", press: "אישור הסקירה מעביר למסירה. שום דבר לא נמסר לפני האישור, אלא אם הגדרתם שער אוטומטי." },
