...
export const ONBOARDING_CONCEPTS: Concept[] = [
  ...
  { key: "onboarding_review", kind: "button", title: "סקירת הקבצים", aliases: ["review", "סקירה"], screens: ["onboarding"], explain: "רשימת כל הקבצים שהסשן שינה, עם לפני/אחרי, לקריאה בלבד. ההטמעה הסתיימה והטרמינל נעול, ואי אפשר לחזור אליה.", press: "אישור הסקירה מעביר למסירה. שום דבר לא נמסר לפני האישור, אלא אם הגדרתם שער אוטומטי." },
