...
export const ONBOARDING_CONCEPTS: Concept[] = [
  ...
  { key: "init", kind: "button", title: "הטמעה", aliases: ["init", "/init", "הרץ הטמעה"], screens: ["onboarding"], explain: "Claude Code האמיתי רץ בטרמינל שלמטה ומריץ /init: קורא את המאגר וכותב את קובצי ההנחיה (CLAUDE.md ועוד) בעותק המבודד. אתם עונים לו בטרמינל.", press: "נפתח סשן חי בטרמינל. הוא עולה כסף כל עוד הוא רץ, וכשמסיימים לוחצים 'סיימתי עם ההטמעה'." },
  { key: "onboarding_review", kind: "button", title: "סקירה", aliases: ["review", "סקירת הקבצים"], screens: ["onboarding"], explain: "רשימת כל הקבצים שהסשן שינה, עם לפני/אחרי. אפשר לבקש מהסשן תיקונים ולרענן.", press: "אישור הסקירה מעביר למסירה. שום דבר לא נמסר לפני האישור, אלא אם הגדרתם שער אוטומטי." },
