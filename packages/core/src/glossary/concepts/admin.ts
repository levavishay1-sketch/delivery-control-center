...
export const ADMIN_CONCEPTS: Concept[] = [
  ...
  { key: "prompt_body", kind: "field", title: "גוף הפרומפט", explain: "ההוראות עצמן שנשלחות לקלוד. עריכה כאן משנה כל קריאה עתידית מאותו שלב, בכל הלקוחות — לכן כדאי לקרוא את התצוגה המקדימה לפני שמירה." },
