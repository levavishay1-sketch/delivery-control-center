...
export const TASK_CONCEPTS: Concept[] = [
  ...
  { key: "check", kind: "term", title: "בדיקה", aliases: ["בדיקות", "check"], screens: ["task"], explain: "משימה שרק מוודאת שמשהו עובד — קלוד מריץ אותה בלי יכולת לשנות קוד. לכל משימה נוספות אוטומטית שלוש: Build, בדיקות לפיתוח ורגרסיה; הן רצות אחרי הפיתוח, קודם ה-Build ואז השאר." },
  ...
  { key: "task_status", kind: "field", title: "סטטוס המשימה", aliases: ["סטטוס", "מצב המשימה"], screens: ["task"], explain: "איפה המשימה עומדת, מחושב מההרצה, מהבדיקות ומהתלויות: ממתינה לאישור, קיימת תלות, מוכנה, בעבודה (פיתוח / Build / בדיקות), נפלה ולמה, הסתיימה וממתינה לתלות, ממתינה לסקירה, הסתיימה." },
  { key: "add_e2e_check", kind: "button", title: "הוסף בדיקות E2E", screens: ["task"], explain: "מוסיף למשימה בדיקה שמריצה את כל התהליך כמו משתמש, בכלי ה-end-to-end של המאגר. לבחירה — לא כל משימה צריכה.", press: "הבדיקה נוספת לרשימה ותרוץ בהרצה הבאה, אחרי ה-Build. אם אין במאגר כלי כזה, היא תגיד את זה." },
