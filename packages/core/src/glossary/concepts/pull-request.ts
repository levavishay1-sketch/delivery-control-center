...
export const PULL_REQUEST_CONCEPTS: Concept[] = [
  ...
  { key: "pr_conflict_files", kind: "term", title: "הקבצים בהתנגשות", aliases: ["קבצים מתנגשים", "קבצים בהתנגשות"], screens: ["pull_request"], explain: "הקבצים שהענף והיעד שינו בהם את אותן שורות. לחיצה על השורה 'התנגשות מול היעד' פותחת אותם בלשונית קבצים, תחת 'בהתנגשות'. 'חשודים' = ששני הצדדים שינו, ולא בטוח שההתנגשות בכולם." },
