...
const claude: ScreenGlossary = {
  ...
  entries: [
    ...
    { key: "retention", kind: "term", title: "שמירה", aliases: ["תקופת שמירה", "retention"], explain: "כמה זמן תוכן השיחות נשמר. אחרי התקופה הטקסט נמחק; רשומות הקריאה והעלות נשארות לתמיד." },
  ],
};
